...
export const articles: ArticleSet = {
  fr: [
    {
      slug: "officine-balance-agee-tiers-payant",
      category: "Pharmacie",
      title: "Officine : solder le stock de créances tiers-payant avant qu'il ne devienne une perte",
      desc: "ARL négatifs, rejets oubliés, virements non lettrés : comment trier et solder le stock de créances tiers-payant anciennes avant qu'il ne devienne une perte sèche.",
      time: "9 min",
      body: [
    ...
    {
      slug: "orthodontie-facturation-traitements-longs",
      category: "Orthodontie",
      title: "Orthodontie : fiabiliser la facturation des traitements longs, semestre après semestre",
      desc: "DEP, codes semestriels, bascule à 16 ans, mensualités patient : les points de rupture du tiers-payant orthodontique et comment sécuriser un dossier sur plusieurs années.",
      time: "9 min",
      body: [
    ...
    {
      slug: "dentaire-paniers-100-sante-tiers-payant",
      category: "Dentaire",
      title: "Dentaire : sécuriser le tiers-payant sur les paniers 100% Santé",
      desc: "RAC0, panier maîtrisé, devis normalisé : pourquoi le tiers-payant des prothèses dentaires est devenu un risque de trésorerie, et comment le fiabiliser dossier par dossier.",
      time: "8 min",
      body: [
  ...
  en: [
    {
      slug: "pharmacy-aged-third-party-receivables",
      category: "Pharmacy",
      title: "Pharmacy: clearing the third-party receivables backlog before it turns into a write-off",
      desc: "Failed acknowledgements, forgotten rejections, unreconciled transfers: how to sort and clear the backlog of ageing third-party receivables before it becomes a pure loss.",
      time: "9 min",
      body: [
    ...
    {
      slug: "orthodontics-long-treatment-billing",
      category: "Orthodontics",
      title: "Orthodontics: making semester-by-semester billing reliable over long treatments",
      desc: "Prior authorization, semester-based codes, the age-16 cutoff, patient installment plans: the orthodontic billing failure points, and how to keep a file reliable over several years.",
      time: "9 min",
      body: [
    ...
    {
      slug: "dental-zero-cost-basket-billing",
      category: "Dental",
      title: "Dental care: securing third-party billing on the zero-cost-to-patient baskets",
      desc: "Zero-cost baskets, tiered pricing, standardized quotes: why prosthetic dental billing has become a cash-flow risk, and how to make it reliable case by case.",
      time: "8 min",
      body: [
